...
class Header extends React.Component {
    ...
    google = () => {
        ...
        window.open("https://zomato-clone-backend-r5e6.onrender.com/auth/google", "_self");
    }

    logout = () => {
         // window.open(`${BASE_URL}/auth/logout`, "_self");
        window.open("https://zomato-clone-backend-r5e6.onrender.com/auth/logout", "_self");
    };
    ...
    handleSignUp = (e) => {
        ...
        // axios.post(`${BASE_URL}/signup`, { name, email, password })
         axios.post(`https://zomato-clone-backend-r5e6.onrender.com/signup`, { name, email, password })
    ...
    handleLogin = (e) => {
        ...
        // axios.post(`${BASE_URL}/login`, { email, password })
          axios.post(`https://zomato-clone-backend-r5e6.onrender.com/login`, { email, password })
            .then(result => {
                console.log(result)
